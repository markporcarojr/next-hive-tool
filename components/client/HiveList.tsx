...
export default function ClientHiveList({ hives }: { hives: HiveInput[] }) {
  const [localHives, setLocalHives] = useState(hives);
  ...
  const handleDelete = async () => {
    ...
    if (res.ok) {
      setLocalHives((prev) => prev.filter((h) => h.id !== hiveToDelete));
      close();
